#!/usr/bin/env python3
"""Output-quality diagnostics for frontier predictions.

Diagnostic only. Reported accuracies come from eval/eval_canonical.py; this
script characterises HOW an output failed, it does not score.
